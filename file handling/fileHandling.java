...
public class fileHandling {
	...
	public void config() {
		...
		System.out.println("File Handling Console. ### Current Path: "+this.currentPath.toString()+"\n Please define new Path :");
		userConfigInput = this.sc.next();
		this.currentPath = Paths.get(userConfigInput);
		System.out.println("File Handling Console. ### Current File: "+this.currentFile.toString()+"\n Please define new File :");
		userConfigInput = this.sc.next();
	...
	public void appendFile(Path filePath) {
		String content;
		sc.reset();
		System.out.println("Add text to append to file:\n");
		content = this.sc.nextLine();
		content = this.sc.nextLine();
		System.out.println("Add new line \\n ? [Y\\N]");
		if((this.sc.next("[nNyY]")).toLowerCase().contains("y")) {content=content+"\n";}
	...
	public static void main(String[] args) {
		...
		do {
		System.out.println("File Handling Console. ### Current Path: "+fileHandler.currentPath.toString()+" ### Current File Name: "+fileHandler.currentFile.toString()+"\nOptions:\n1-Create New File\n2-Append to existing File\n3-Read Existing File\n4-Delete existing File.\n5-Define Path and Filename\nQ-Exit.");
